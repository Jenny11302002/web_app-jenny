  ...
  return (
    <div>
      ...
      <div className="text-center py-20 bg-gray-50">
        <h2 className="text-4xl font-bold text-blue-900 mb-4">Order Your Volkswagen Today</h2>
        ...
        <form className="max-w-md mx-auto bg-white shadow-md p-6 rounded-2xl">
          ...
          <select className="w-full mb-4 p-2 border rounded-lg">
            <option>Select Volkswagen Model</option>
            <option>Volkswagen Golf</option>
            <option>Volkswagen Sedan</option>
            <option>Volkswagen  Virtus</option>
          </select>
